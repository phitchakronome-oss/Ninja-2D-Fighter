...
## เริ่มเกมและโหมดทดสอบ

หน้าแรกมีโหมดเล่นแบบธรรมดาและโหมดสูตรโกง โดยเลือกเปิดจักระไม่จำกัด เลือดไม่จำกัด และคูลดาวน์ 0 ได้ก่อนกดเริ่มเกม เกมใช้ Kaito เป็นตัวละครหลักโดยไม่ต้องผ่านหน้าเลือกตัวละคร
...
> สูตรโกงถูกเลือกจากหน้า Start และ HUD จะแสดง `∞ TEST` หรือ `CHEAT` ตามตัวเลือกที่เปิด
